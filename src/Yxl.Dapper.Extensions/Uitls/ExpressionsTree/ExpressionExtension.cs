...
{
    internal static class ExpressionUitls
    {
        #region 表达式类型字典
        /// <summary>
        /// 表达式类型字典
        ...
        public static MemberExpression? GetRootMember(this MemberExpression e)
        {
            ...
            return e.Expression.NodeType == ExpressionType.MemberAccess ? ((MemberExpression)e.Expression).GetRootMember() : null;
        }
        #endregion
        ...
        {
            var topMember = memberExpression.GetRootMember();
            if (topMember == null)
